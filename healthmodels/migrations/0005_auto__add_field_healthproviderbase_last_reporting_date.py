...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HealthProviderBase.last_reporting_date'
        db.add_column('healthmodels_healthproviderbase', 'last_reporting_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HealthProviderBase.last_reporting_date'
        db.delete_column('healthmodels_healthproviderbase', 'last_reporting_date')
