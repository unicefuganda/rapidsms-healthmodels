...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HealthFacilityBase.owner'
        db.add_column('healthmodels_healthfacilitybase', 'owner', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True), keep_default=False)

        # Adding field 'HealthFacilityBase.authority'
        db.add_column('healthmodels_healthfacilitybase', 'authority', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HealthFacilityBase.owner'
        db.delete_column('healthmodels_healthfacilitybase', 'owner')

        # Deleting field 'HealthFacilityBase.authority'
        db.delete_column('healthmodels_healthfacilitybase', 'authority')
