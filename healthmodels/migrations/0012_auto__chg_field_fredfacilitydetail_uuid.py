...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'FredFacilityDetail.uuid' to match new field type.
        db.rename_column('healthmodels_fredfacilitydetail', 'uuid', 'uuid_id')
        # Changing field 'FredFacilityDetail.uuid'
        db.alter_column('healthmodels_fredfacilitydetail', 'uuid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmodels.HealthFacilityBase'], to_field='uuid', unique=True))
        # Adding index on 'FredFacilityDetail', fields ['uuid']
        db.create_index('healthmodels_fredfacilitydetail', ['uuid_id'])


    def backwards(self, orm):
        # Removing index on 'FredFacilityDetail', fields ['uuid']
        db.delete_index('healthmodels_fredfacilitydetail', ['uuid_id'])


        # Renaming column for 'FredFacilityDetail.uuid' to match new field type.
        db.rename_column('healthmodels_fredfacilitydetail', 'uuid_id', 'uuid')
        # Changing field 'FredFacilityDetail.uuid'
        db.alter_column('healthmodels_fredfacilitydetail', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))
    ...
    models = {
        ...
        'healthmodels.fredfacilitydetail': {
            ...
            'h033b': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uuid': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['healthmodels.HealthFacilityBase']", 'to_field': "'uuid'", 'unique': 'True'})
        },
