...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HealthFacility.supply_point'
        db.delete_column('healthmodels_healthfacility', 'supply_point_id')

        # Deleting field 'PatientEncounter.submission'
        db.delete_column('healthmodels_patientencounter', 'submission_id')

        # Deleting field 'PatientEncounter.reporter'
        db.delete_column('healthmodels_patientencounter', 'reporter_id')

        # Deleting field 'PatientEncounter.message'
        db.delete_column('healthmodels_patientencounter', 'message_id')

        # Deleting field 'PatientEncounter.valid'
        db.delete_column('healthmodels_patientencounter', 'valid')

        # Deleting field 'HealthFacilityBase.district'
        db.delete_column('healthmodels_healthfacilitybase', 'district')

        # Deleting field 'FacilityReport.submission'
        db.delete_column('healthmodels_facilityreport', 'submission_id')

        # Deleting field 'FacilityReport.reporter'
        db.delete_column('healthmodels_facilityreport', 'reporter_id')

        # Deleting field 'FacilityReport.message'
        db.delete_column('healthmodels_facilityreport', 'message_id')

        # Deleting field 'FacilityReport.valid'
        db.delete_column('healthmodels_facilityreport', 'valid')
