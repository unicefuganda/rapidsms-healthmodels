...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealthFacilityBase.active'
        db.add_column('healthmodels_healthfacilitybase', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealthFacilityBase.active'
        db.delete_column('healthmodels_healthfacilitybase', 'active')
