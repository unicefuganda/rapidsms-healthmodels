...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FredFacilityDetail.h003b'
        db.delete_column('healthmodels_fredfacilitydetail', 'h003b')

        # Adding field 'FredFacilityDetail.h033b'
        db.add_column('healthmodels_fredfacilitydetail', 'h033b',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FredFacilityDetail.h003b'
        db.add_column('healthmodels_fredfacilitydetail', 'h003b',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'FredFacilityDetail.h033b'
        db.delete_column('healthmodels_fredfacilitydetail', 'h033b')
