...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealthFacilityBase.deleted'
        db.add_column('healthmodels_healthfacilitybase', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealthFacilityBase.deleted'
        db.delete_column('healthmodels_healthfacilitybase', 'deleted')
